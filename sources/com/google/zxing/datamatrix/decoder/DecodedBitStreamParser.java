...
final class DecodedBitStreamParser {
    ...
    private static final char[] C40_SHIFT2_SET_CHARS = {'!', '\"', '#', '$', PatternFormatter.PERCENT_CONVERSION_CHAR, '&', '\'', '(', ')', '*', '+', ',', '-', '.', '/', ':', ';', '<', '=', '>', '?', '@', '[', '\\', ']', '^', '_'};
    ...
    private static final char[] TEXT_SHIFT3_SET_CHARS = {'`', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', PatternFormatter.PRIORITY_CONVERSION_CHAR, 'Q', 'R', 'S', PatternFormatter.THROWABLE_CONVERSION_CHAR, 'U', 'V', 'W', 'X', 'Y', 'Z', '{', '|', '}', '~', 127};
    ...
    static com.google.zxing.common.DecoderResult decode(byte[] r7) throws com.google.zxing.FormatException {
        ...
        L_0x001a:
            ...
            goto L_0x0053
        L_0x0023:
            int[] r6 = com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C04001.f29xb73eb560
            int r5 = r5.ordinal()
            r5 = r6[r5]
    ...
    static /* synthetic */ class C04001 {
        ...
        static final /* synthetic */ int[] f29xb73eb560 = new int[Mode.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f29xb73eb560 = r0
                int[] r0 = f29xb73eb560     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f29xb73eb560     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f29xb73eb560     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f29xb73eb560     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f29xb73eb560     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C04001.<clinit>():void");
        }
    }
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 2) {
                            ...
                            sb.append((char) (i3 + BuildConfig.VERSION_CODE));
                        } else {
