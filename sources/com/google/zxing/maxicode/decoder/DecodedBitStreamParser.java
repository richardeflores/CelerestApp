...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f31FS = '\u001c';

    /* renamed from: GS */
    private static final char f32GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f33NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f34RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f32GS + format + f32GS + format2 + f32GS);
            } else {
                sb.insert(0, str + f32GS + format + f32GS + format2 + f32GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, SyslogMessage.FACILITY_LOCAL_USE_3, SyslogMessage.FACILITY_LOCAL_USE_4, SyslogMessage.FACILITY_LOCAL_USE_5, SyslogMessage.FACILITY_LOCAL_USE_6, SyslogMessage.FACILITY_LOCAL_USE_7, 24, SyslogMessage.FACILITY_LOG_AUDIT, SyslogMessage.FACILITY_LOG_ALERT, 15, SyslogMessage.FACILITY_LOCAL_USE_0, SyslogMessage.FACILITY_LOCAL_USE_1, SyslogMessage.FACILITY_LOCAL_USE_2, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, SyslogMessage.FACILITY_LOCAL_USE_3, SyslogMessage.FACILITY_LOCAL_USE_4})), SETS[0].charAt(getInt(bArr, new byte[]{SyslogMessage.FACILITY_LOCAL_USE_5, SyslogMessage.FACILITY_LOCAL_USE_6, SyslogMessage.FACILITY_LOCAL_USE_7, 24, SyslogMessage.FACILITY_LOG_AUDIT, SyslogMessage.FACILITY_LOG_ALERT})), SETS[0].charAt(getInt(bArr, new byte[]{15, SyslogMessage.FACILITY_LOCAL_USE_0, SyslogMessage.FACILITY_LOCAL_USE_1, SyslogMessage.FACILITY_LOCAL_USE_2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
