...
public class BloodFatResultDetailFragment_xx extends AppBaseFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        if (this.rootView == null) {
            this.rootView = layoutInflater.inflate(C0418R.layout.fragment_blood_fat_result_detail_xx, (ViewGroup) null);
        }
