...
public class NickNameOperateDialog extends BaseDialog implements View.OnClickListener {
    ...
    public NickNameOperateDialog(Context context2) {
    ...
    public void show() {
        ...
        window.setContentView(C0418R.layout.widget_dialog_nick_name_operate);
