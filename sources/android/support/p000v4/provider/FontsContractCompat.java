...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.provider.FontsContractCompat.C01615.compare(byte[], byte[]):int");
        }
    };
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, final TextView textView, int i, int i2, final int i3) {
        final String str = fontRequest.getIdentifier() + SimpleFormatter.DEFAULT_DELIMITER + i3;
        ...
        C01481 r1 = new Callable<Typeface>() {
        ...
        if (z) {
            ...
            C01492 r5 = new SelfDestructiveThread.ReplyCallback<Typeface>() {
